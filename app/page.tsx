...
const basePath = '/core-tech-1776672570293';
...
export default function Home() {
  ...
  const products = [{ n: 'Hosting', d: 'Our Hosting services provide fast, secure, and reliable infrastructure for businesses to host their websites, applications, and data, ensuring maximum uptime and performance. With flexible plans and expert support, we help clients find the perfect hosting solution for their needs.', i: 'https://images.pexels.com/photos/17489152/pexels-photo-17489152.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Web Dev', d: 'Our Web Dev services offer custom website development solutions, designed to enhance user experience, drive engagement, and boost conversions. From e-commerce platforms to corporate websites, our team of experts crafts tailored solutions that meet the unique goals and objectives of each client.', i: 'https://images.pexels.com/photos/14553720/pexels-photo-14553720.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'App Dev', d: 'Our App Dev services enable businesses to leverage the power of mobile applications, creating bespoke solutions that drive customer engagement, improve operational efficiency, and unlock new revenue streams. With expertise in both iOS and Android development, we help clients bring their app ideas to life.', i: 'https://images.pexels.com/photos/54284/pexels-photo-54284.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Domain', d: 'Our Domain registration services provide a straightforward and secure way for businesses to register and manage their domain names, ensuring that their online presence is protected and easily accessible to their target audience. With competitive pricing and expert support, we make domain management simple and hassle-free.', i: 'https://images.pexels.com/photos/4160092/pexels-photo-4160092.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Inquiries', d: 'Our Inquiries service offers a dedicated point of contact for businesses seeking advice, guidance, or support on their technology-related projects. Whether it\'s exploring new solutions, addressing technical issues, or simply seeking expert opinion, our team is always available to help clients make informed decisions and drive their business forward.', i: 'https://images.pexels.com/photos/7709227/pexels-photo-7709227.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Core Tech, we specialize in providing cutting-edge technology solutions to businesses in Kuching, focusing on delivering exceptional service and driving innovation. Our team of experts is committed to helping clients achieve their goals through tailored hosting, web development, and application development services. With a customer-centric approach, we strive to build long-term relationships and drive growth.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To become the leading technology solutions provider in Kuching, renowned for our expertise, reliability, and commitment to customer satisfaction.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To deliver innovative, high-quality technology solutions that meet the evolving needs of our clients, while maintaining a customer-first approach and fostering a culture of continuous innovation and improvement.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Customer first</h4>
                  <p className="text-sm text-on-surface-variant">At Core Tech, our \'Customer First\' core value means that we prioritize the needs and satisfaction of our clients, ensuring that every interaction and solution is tailored to meet their unique requirements and expectations.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Innovation</h4>
                  <p className="text-sm text-on-surface-variant">Our commitment to \'Innovation\' drives us to stay at the forefront of the latest technologies and trends, enabling us to develop creative and effective solutions that help our clients stay ahead of the competition.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.pexels.com/photos/20988575/pexels-photo-20988575.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 1" className="w-full h-full object-cover" />
              </div>
              ...
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/19895843/pexels-photo-19895843.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
